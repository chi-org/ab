CREATE OR REPLACE VIEW public.main_db4_H__mua_ban_view AS
SELECT
...
FROM public."main_db4_H__mua_ban";

-- DROP VIEW public.main_db4_H__mua_ban_view

CREATE OR REPLACE VIEW public.main_db5_H__mua_ban_view AS
SELECT
...
FROM public."main_db5_H__mua_ban";

-- DROP VIEW public.main_db5_H__mua_ban_view

CREATE OR REPLACE VIEW public.main_db6_H__mua_ban_view AS
SELECT
    ...
    "HTKT",
    "Thong_bao_sale_SDM___ien_ngay_thong_bao_" as "Thông báo sale/SDM"
FROM public."main_db6_H__mua_ban";
