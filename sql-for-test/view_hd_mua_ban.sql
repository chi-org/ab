CREATE OR REPLACE VIEW public.invt4_H__mua_ban_view AS
SELECT
...
FROM public."invt4_H__mua_ban";

-- DROP VIEW public.invt4_H__mua_ban_view

CREATE OR REPLACE VIEW public.invt5_H__mua_ban_view AS
SELECT
    "Hop__ong" as "Hợp đồng",
    "Loai_H_" as "Loại HĐ",
    "Sale",
...
FROM public."invt5_H__mua_ban";

-- DROP VIEW public.invt5_H__mua_ban_view

CREATE OR REPLACE VIEW public.invt6_H__mua_ban_view AS
SELECT
    "So_H_" as "Hợp đồng",
    "Loai_H_" as "Loại HĐ",
    "Sale",
    ...
    "HTKT",
    "Thong_bao_sale_SDM___ien_ngay_thong_bao_" as "Thông báo sale/SDM"
FROM public."invt6_H__mua_ban";

-- DROP VIEW public.invt6_H__mua_ban_view
