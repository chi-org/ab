CREATE OR REPLACE VIEW public.main_db4_H__cho_thue_view AS
SELECT
...
FROM public."main_db4_H__cho_thue___Sua_chua";

-- DROP VIEW public.main_db4_H__cho_thue_view

CREATE OR REPLACE VIEW public.main_db5_H__cho_thue_view AS
SELECT
    ...
    "GAP_HTKT__thang_" as "GAP HTKT (tháng)",
    handle_date_text("Ngay_nhan_thong_tin_tu_PM") AS "Ngày nhận thông tin từ PM"
FROM public."main_db5_H__cho_thue___Sua_chua";

-- DROP VIEW public.main_db5_H__cho_thue_view

CREATE OR REPLACE VIEW public.main_db6_H__cho_thue_view AS
SELECT
    ...
    "GAP_HTKT__thang_" as "GAP HTKT (tháng)",
    handle_date_text("Ngay_nhan_thong_tin_tu_PM") AS "Ngày nhận thông tin từ PM"
FROM public."main_db6_H__cho_thue___Sua_chua";
...
FROM main_db6_H__cho_thue_view
UNION ALL
SELECT
    "Source",
    "Hợp đồng",
    ...
    "GAP HTKT (tháng)",
    "Ngày nhận thông tin từ PM"
FROM main_db5_H__cho_thue_view
UNION ALL
SELECT
    "Source",
    "Hợp đồng",
    ...
    "GAP HTKT (tháng)",
    "Ngày nhận thông tin từ PM"
FROM main_db4_H__cho_thue_view;
