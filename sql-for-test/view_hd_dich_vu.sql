CREATE OR REPLACE VIEW public.invt4_h_dich_vu_view AS
SELECT
    ...
    "Service_Level_P1" as "Service Level 1",
    ...
    "Vendor_Contract_ID",
    "Service_Level_V1" as "Service Level 2",
...
FROM public."invt4_H__Dich_Vu";

-- DROP VIEW public.invt4_h_dich_vu_view

CREATE OR REPLACE VIEW public.invt5_h_dich_vu_view AS
SELECT
...
FROM public."invt5_H__Dich_Vu";

-- DROP VIEW public.invt5_h_dich_vu_view

CREATE OR REPLACE VIEW public.invt6_h_dich_vu_view AS
SELECT
...
FROM public."invt6_H__dich_vu";

-- DROP VIEW public.invt6_h_dich_vu_view
...
SELECT
    ...
    "SN bảo hành (nếu có)",
    "Thời hạn BH customer (tháng)",
    NULL AS "Service Level 1",
    NULL AS "Service Level 2",
    "Customer Start Date",
    "Customer warranty expiry date",
    "Customer technical support expiry date",
    "Vendor Warranty expiry date",
